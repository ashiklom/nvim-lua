...
vim.keymap.set('n', '<leader>fo', MiniFiles.open, {silent=true, desc="Open working directory"})
vim.keymap.set('n', '<leader>fO', function() MiniFiles.open(vim.buf_get_name(0)) end, {silent=true, desc="Open file directory"})
