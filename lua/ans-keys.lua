...
vim.keymap.set('n', '<leader>fo', [[:Oil . --float<CR>]], {silent=true, desc="Open working directory"})
vim.keymap.set('n', '<leader>fO', [[:Oil %:h --float<CR>]], {silent=true, desc="Open file directory"})
